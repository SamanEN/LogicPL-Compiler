	...
	public final ImplicationContext implication() throws RecognitionException {
		...
		try {
			...
			match(RPAR);
			        ...
			        _localctx.implicationRet.setLine(((ImplicationContext)_localctx).ARROW.getLine());
	...
	public final Expression2Context expression2() throws RecognitionException {
		...
		try {
			...
			case OR:
				...
				_localctx.expression2Ret.setLine(((Expression2Context)_localctx).OR.getLine());
				}
				break;
			case RPAR:
			case COMMA:
			...
			case AND:
				...
				((AndExpr2Context)_localctx).right = andExpr2();
				        ...
				        if(((AndExpr2Context)_localctx).right.andExpr2Ret != null)
				        {
				            ...
				            ((AndExpr2Context)_localctx).andExpr2Ret =  new BinaryExpression(null, _localctx.temp, BinaryOperator.and);
				        }
				        else
				        {
				            ((AndExpr2Context)_localctx).andExpr2Ret =  new BinaryExpression(null, ((AndExpr2Context)_localctx).left.eqExprRet, BinaryOperator.and);
				        }   
				    
				_localctx.andExpr2Ret.setLine(((AndExpr2Context)_localctx).AND.getLine());
				}
				break;
			case RPAR:
			case COMMA:
	...
	public final EqExpr2Context eqExpr2() throws RecognitionException {
		...
		try {
			...
			case NEQ:
				...
				_localctx.eqExpr2Ret.setLine(((EqExpr2Context)_localctx).op.getLine());
				}
				break;
			case RPAR:
			case COMMA:
	...
	public final CompExpr2Context compExpr2() throws RecognitionException {
		...
		try {
			...
			case LTE:
				...
				_localctx.compExpr2Ret.setLine(((CompExpr2Context)_localctx).op.getLine());
				}
				break;
			case RPAR:
			case COMMA:
	...
	public final Additive2Context additive2() throws RecognitionException {
		...
		try {
			...
			case MINUS:
				...
				_localctx.additive2Ret.setLine(((Additive2Context)_localctx).op.getLine());
				}
				break;
			case RPAR:
			case COMMA:
	...
	public final Multicative2Context multicative2() throws RecognitionException {
		...
		try {
			...
			case MOD:
				...
				_localctx.multicative2Ret.setLine(((Multicative2Context)_localctx).op.getLine());
				}
				break;
			case RPAR:
			case COMMA:
